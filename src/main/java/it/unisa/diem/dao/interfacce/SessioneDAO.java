...
/**
 *  SessioneDAO
 *  Interfaccia per le operazioni CRUD sulle sessioni
 *
...
public interface SessioneDAO extends DAO<Sessione> {
    ...
    /**
     *  Cerca l'ultima sessione di un utente
    ...
    /**
     *  Recupera le ultime sessioni di un utente per difficoltà
    ...
    /**
     *  Recupera la classifica per difficoltà
     * @param difficolta Livello di difficoltà
